# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-16 13:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index_curent_apa_rece', models.FloatField(default=0.0, validators=[django.core.validators.MinValueValidator(0.0)])),
                ('index_curent_apa_calda', models.FloatField(default=0.0, validators=[django.core.validators.MinValueValidator(0.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.date(2017, 12, 16))),
